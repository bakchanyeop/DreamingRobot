            ...
            if event.type == pygame.JOYAXISMOTION:  # 조이스틱 축 움직임 이벤트
                ...
                if axis == 0:  # X 축 (좌우)
                    ...
                    if value < -0.5:
                        ...
                        my_walk = [(0,0,18),(-4,0,18),(-8,0,18), (1,0,15),(0,0,18),(-4,0,18)]
                        my_walk_1 = [(0,0,18),(-4,0,18),(-8,0,18),(1,0,15),(0,0,18),(-4,0,18)]
                        w_offset=9
                        delay=0.01
                    elif value > 0.5:
                        perform_interrupt("Backward")
                        my_walk=[(2,0,18), (-3,0, 15),(-3,0,18),(-1,0,18),(2,0,18),(-3,0,15)]                        
#my_walk = [(2,0,18),(-3,0,15),(-2,0,18), (0,0,18),(2,0,18),(-3,0,15)]
...
##################
        ...
        A=math.sqrt(x**2+y**2)
        L=math.sqrt(z**2+A**2)
        C=(math.acos((13**2+13**2-L**2)/(2*13*13))*180/3.14)+1 #-7.7 Leg foot degree
...
##################        
        ...
        A=math.sqrt(x**2+y**2)
        L=math.sqrt(z**2+A**2)
        C=(math.acos((13**2+13**2-L**2)/(2*13*13))*180/3.14)+1
...
##########################
    ...
    #    print(param_goal_position)
        ...
        dxl_goal_position=Center_Data-int((CTD(180)-CTD(C_Degree))/2)+CTD(int(walk_deg)-w_offset-2)
        param_goal_position =[DXL_LOBYTE(DXL_LOWORD(dxl_goal_position)), DXL_HIBYTE(DXL_LOWORD(dxl_goal_position)),DXL_LOBYTE(DXL_HIWORD(dxl_goal_position)), DXL_HIBYTE(DXL_HIWORD(dxl_goal_position))]
...
##########################
        ...
        dxl_goal_position=Center_Data+int((CTD(180)-CTD(C_Degree_1))/2)-CTD(int(walk_deg_1)-w_offset-2)
        param_goal_position =[DXL_LOBYTE(DXL_LOWORD(dxl_goal_position)), DXL_HIBYTE(DXL_LOWORD(dxl_goal_position)),DXL_LOBYTE(DXL_HIWORD(dxl_goal_position)), DXL_HIBYTE(DXL_HIWORD(dxl_goal_position))]
...
##########################
        ...
        param_goal_position =[DXL_LOBYTE(DXL_LOWORD(dxl_goal_position)),     DXL_HIBYTE(DXL_LOWORD(dxl_goal_position)),DXL_LOBYTE(DXL_HIWORD(dxl_goal_position)), DXL_HIBYTE(DXL_HIWORD(dxl_goal_position))]
        dxl_addparam_result = groupSyncWrite.addParam(8, param_goal_position)
        print('SAME')
